			...
			'<div class="row faq-container">'
				+'<div class="col s12">'
					+'<ul class="collapsible" data-collapsible="accordion">'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>TO BE A VOLUNTEER</div>'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>RULES OF ENGAGEMENT</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>DEADLINE FOR DEREGISTRATION</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>SHIFTS</div>'
		      				+'<div class="collapsible-body">'
						...
						+'</li>'
						+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>ALCOHOL POLICY</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>VALUABLES</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>CLOTHING</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>MEALS FOR VOLUNTEERS</div>'
			      			+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>VOLUNTEER LOUNGE</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>WARDROBE</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>ROSTERS</div>'
		      				+'<div class="collapsible-body">'
		      					+'<p>Your roster will be released during May. You can find it by logging on to RUBY and selecting “MY SHIFTS”</p>'
		      				+'</div>'
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>CHECK–IN</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>' 
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>HYGIENE</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>SAFETY</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>CONTACT INFORMATION</div>'
		      				+'<div class="collapsible-body">'
			...
			'<div class="row faq-container">'
				+'<div class="col s12">'
					...
					+'<ul class="collapsible" data-collapsible="accordion">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>HOURS OF EFFORT & DISTRIBUTION</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>SHIFT SWAP</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>SHIFT SCHEDULE</div>'
		      				+'<div class="collapsible-body">'
						...
						+'</li>'
						+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>INSURANCE</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>AUDIO & FOOTAGE</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>CHECK-IN & WRISTBANDS</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>LOST & FOUND</div>'
			      			+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>FOOD & DRINKS</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>ACCOMMODATION</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>PARKING CARS/BIKES</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>CANCELLATION AND ILLNESS</div>'
		      				+'<div class="collapsible-body">'
		      					+'<p>Please read our <a href="http://www.tinderbox.dk/en/rules-of-engagement/">Rules of Engagement.</a>'
								+'<br>'
								+'<br>'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>DEADLINE OF CANCELLATION / MANDATORY REGISTRATION</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>POLICY OF AGE</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>HELP, I CAN’T LOG IN!</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>WHO’S RUBY?</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>CHOOSING A TEAM</div>'
		      				+'<div class="collapsible-body">'
		      					+'<p><b>A team</b>'
		      					+'<br>'
		      					+'<br>'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>MISSING CONFIRMATION MAIL?</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>SIGN-UP AS A VOLUNTEER AT TINDERBOX</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>GUARANTEE OF SPOT</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>TECHNICAL ERROR</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>SHIFTS WITH A FRIEND</div>'
		      				+'<div class="collapsible-body">'
			    		...
			    		+'</li>'
			    		+'<li>'
			      			+'<div class="collapsible-header white-text"><i class="material-icons">play_arrow</i>WAITING LIST</div>'
		      				+'<div class="collapsible-body">'
