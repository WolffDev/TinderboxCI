...
function information() {
	var html =
		...
		+'<ul class="collapsible" data-collapsible="accordion">'
    		+'<li>'
      			+'<div class="collapsible-header"><i class="material-icons">filter_drama</i>To be a volunteer</div>'
    		...
    		+'</li>'
    		+'<li>'
      			+'<div class="collapsible-header"><i class="material-icons">filter_drama</i>RULES OF ENGAGEMENT</div>'
      				+'<div class="collapsible-body">'
    		...
    		+'</li>'
    		+'<li>'
      			+'<div class="collapsible-header"><i class="material-icons">filter_drama</i>DEADLINE FOR DEREGISTRATION</div>'
      				+'<div class="collapsible-body">'
    		...
    		+'</li>'
    		+'<li>'
      			+'<div class="collapsible-header"><i class="material-icons">filter_drama</i>SHIFTS</div>'
      				+'<div class="collapsible-body">'
			...
			+'</li>'
			+'<li>'
      			+'<div class="collapsible-header"><i class="material-icons">filter_drama</i>ALCOHOL POLICY</div>'
      				+'<div class="collapsible-body">'
    		...
    		+'</li>'
    		+'<li>'
      			+'<div class="collapsible-header"><i class="material-icons">filter_drama</i>VALUABLES</div>'
      				+'<div class="collapsible-body">'
    		...
    		+'</li>'
    		+'<li>'
      			+'<div class="collapsible-header"><i class="material-icons">filter_drama</i>CLOTHING</div>'
      				+'<div class="collapsible-body">'
    		...
    		+'</li>'
    		+'<li>'
      			+'<div class="collapsible-header"><i class="material-icons">filter_drama</i>MEALS FOR VOLUNTEERS</div>'
	      			+'<div class="collapsible-body">'
    		...
    		+'</li>'
    		+'<li>'
      			+'<div class="collapsible-header"><i class="material-icons">filter_drama</i>VOLUNTEER LOUNGE</div>'
      				+'<div class="collapsible-body">'
    		...
    		+'</li>'
    		+'<li>'
      			+'<div class="collapsible-header"><i class="material-icons">filter_drama</i>WARDROBE</div>'
      				+'<div class="collapsible-body">'
    		...
    		+'</li>'
    		+'<li>'
      			+'<div class="collapsible-header"><i class="material-icons">filter_drama</i>ROSTERS</div>'
      				+'<div class="collapsible-body">'
      					+'<p>Your roster will be released during May. You can find it by logging on to RUBY and selecting “MY SHIFTS”</p>'
      				+'</div>'
    		+'</li>'
    		+'<li>'
      			+'<div class="collapsible-header"><i class="material-icons">filter_drama</i>CHECK–IN</div>'
      				+'<div class="collapsible-body">'
    		...
    		+'</li>'
    		+'<li>'
      			+'<div class="collapsible-header"><i class="material-icons">filter_drama</i>HYGIENE</div>'
      				+'<div class="collapsible-body">'
    		...
    		+'</li>'
    		+'<li>'
      			+'<div class="collapsible-header"><i class="material-icons">filter_drama</i>CONTACT INFORMATION</div>'
      				+'<div class="collapsible-body">'
